 ...
 */
public class SigmaVariableGenerator {

    public static void generate(double [] column) {
        Arrays.sort(column);
        double min = column[0];
    ...
    private static int getCountOfNumbersFromInterval(double start, double end, double[] data) {
        int count = 0;
